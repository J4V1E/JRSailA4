...
{
    public class JRCountryController : Controller
    {
        private readonly SailContext _context;

        public JRCountryController(SailContext context)
        {
            _context = context;
        }
        ...
        // GET: JRCountry/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: JRCountry/Create
